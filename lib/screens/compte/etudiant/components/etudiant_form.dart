...
class CompteEtudiantForm extends StatefulWidget {
  @override
  _CompteEtudiantFormState createState() => _CompteEtudiantFormState();
}

class _CompteEtudiantFormState extends State<CompteEtudiantForm> {
          ...
          DefaultButton(
            ...
            press: () async {
              if (_formKey.currentState.validate()) {
                ...
                var response = await connexion.signUpEtudiant(contactController.value.text, emailController.value.text, nameController.value.text, passwordController.value.text, usernameController.value.text);
                if (response == 401) {
